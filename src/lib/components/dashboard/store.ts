...
export {
    ...
    credentialIdForEdit, editPermissionTrigger, isPermissionChanged, accessSelectorIdentifier, buttonRef, showFolderMenu, menuForFolder, folderDeleteModal,folderOfInterest
} from '../../store/ui.store';
