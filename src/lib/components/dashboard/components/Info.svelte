...
>
  <div
    class="w-full my-2 rounded-lg text-osvauld-ownerText bg-osvauld-ownerGreen text-left pl-4 py-2"
  >
    <h6>Owner</h6>
  ...
  <div
    class="w-full my-2 rounded-lg bg-osvauld-readerOrange text-osvauld-readerText text-left pl-4 py-2"
  >
    <h6>Reader</h6>
    <p>Read only</p>
  </div>
