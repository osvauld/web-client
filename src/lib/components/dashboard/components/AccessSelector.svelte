...
<div
  class="absolute top-2 right-7 !z-[100] w-[8.75rem] h-[6.875rem] bg-osvauld-frameblack border-osvauld-bordergreen ml-auto flex flex-col justify-center items-center"
>
  <button
