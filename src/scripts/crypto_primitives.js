...
*/
export function decrypt_and_store_keys(encrypted_cert_b64, salt_b64, passphrase) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(encrypted_cert_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
/**
*/
export function clear_global_context() {
    wasm.clear_global_context();
}
...
/**
* @param {any} encrypted_text
* @returns {any}
*/
export function decrypt_text(encrypted_text) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.decrypt_text(retptr, addHeapObject(encrypted_text));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function encrypt_fields(fields, public_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.encrypt_fields(retptr, addHeapObject(fields), addHeapObject(public_key));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function import_certificate(cert_string, passphrase) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.import_certificate(retptr, addHeapObject(cert_string), addHeapObject(passphrase));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
export function export_certificate(passphrase, enc_pvt_key, salt) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(enc_pvt_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
